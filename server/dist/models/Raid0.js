...
class Raid0 extends Raid_1.Raid {
    ...
    write(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.disks.some(d => d.getStatus().status === Disk_1.DiskStatus.FAILED)) {
    ...
    getStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isHealthy = diskStatuses.every(s => s.status === Disk_1.DiskStatus.HEALTHY);
            return {
                id: this.id,
                level: this.level,
